...
Output:
    1. A 0 or 1 binary value for each miute of data with 0 representing that the person was not stressed and 
    1 representing stress for the minute.
     
Model Description:
    The support vector machine model was trained with python scikit-learn library with 21 participants data.
